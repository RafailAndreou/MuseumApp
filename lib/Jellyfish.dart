...
class JellyfishScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimalScreen(
      ...
      animalImagePath: "assets/images/Animals/Jellyfish.png",
      animalName: "Jellyfish",
      animalClassification: "Phylum: Cnidaria",
      animalDescription: """ Jellyfish, or sea jellies, are the medusa-phase of certain gelatinous animals in the subphylum Medusozoa, part of the phylum Cnidaria. Mostly free-swimming marine creatures, jellyfish have umbrella-shaped bells for propulsion and stinging tentacles for capturing prey and defense. Their complex life cycle includes a sexual medusa phase and an asexual polyp phase.
