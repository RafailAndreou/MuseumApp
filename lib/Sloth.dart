...
class SlothScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimalScreen(
      ...
      animalImagePath: "assets/images/Animals/Sloth.png",
      animalName: "Sloth",
      animalClassification: "Class: Mammalia",
      animalDescription: """Sloths, belonging to the suborder Folivora, are slow-moving mammals found in Neotropical regions. They spend most of their lives hanging upside down in trees, mainly in South and Central American rainforests. Sloths are closely related to anteaters, forming the xenarthran order Pilosa.
